...
func UnitSquare(c00, c10, c11, c01 colors.Color) []*objects.Triangle {
...
func UnitGradientCube(c000, c100, c110, c010, c001, c101, c111, c011 colors.Color) objects.TransformableObject {
...
// it is centered on the origin point, having sizes of length 1
// so one corner is (-0.5, -0.5, -0.5) and the opposite one is (0.5, 0.5, 0.5), etc
func UnitTextureCube(t1, t2, t3, t4, t5, t6 colors.Texture) objects.TransformableObject {
	return objects.ComplexObject{
		Objs: []objects.TransformableObject{
